...
export const name = "darko7288";

export const email = "darko7288@gmail.com";
export const incorrectEmail = "d8@gmail.com";
export const invalidEmail = "darko7288gmail.com";

export const password = "7288";
export const incorrectPassword = "728";
...
export const accountCreatedPageTitle = "Automation Exercise - Account Created";
export const accountCreatedPageURL = "https://automationexercise.com/account_created";

export const accountDeletedPageTitle = "Automation Exercise - Account Deleted";
export const accountDeletedPageURL = "https://automationexercise.com/delete_account";
...
export const loginBannerText = "Login to your account";
export const loginEmailInputPlaceholder = "Email Address";
export const loginPasswordInputPlaceholder = "Password";
export const loginButtonText = "Login";

export const signupBannerText = "New User Signup!";
export const signupNameInputPlaceholder = "Name";
export const signupEmailInputPlaceholder = "Email Address";
export const signupButtonText = "Signup";
...
export const mrOption = "Mr.";
export const mrsOption = "Mrs.";
